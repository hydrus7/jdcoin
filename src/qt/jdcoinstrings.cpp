...
QT_TRANSLATE_NOOP("jdcoin-core", ""
"Minimum positive amount (in JDC) allowed by GUI and RPC for the stake split "
"threshold (default: %s)"),
QT_TRANSLATE_NOOP("jdcoin-core", ""
...
QT_TRANSLATE_NOOP("jdcoin-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("jdcoin-core", "(default: %s)"),
QT_TRANSLATE_NOOP("jdcoin-core", "(must be %d for %s-net)"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Active Masternode not initialized."),
QT_TRANSLATE_NOOP("jdcoin-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("jdcoin-core", "Allow DNS lookups for -addnode, -seednode and -connect (default: %u)"),
QT_TRANSLATE_NOOP("jdcoin-core", "Allows deprecated RPC method(s) to be used"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Attempt to recover private keys from a corrupt wallet file"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Can't generate a change-address key. Please call keypoolrefill first."),
QT_TRANSLATE_NOOP("jdcoin-core", "Cannot create public spend input"),
QT_TRANSLATE_NOOP("jdcoin-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("jdcoin-core", "Change index out of range"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("jdcoin-core", "Error loading %s: Wallet requires newer version of JDCOIN Core"),
QT_TRANSLATE_NOOP("jdcoin-core", "Error loading %s\n"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("jdcoin-core", "Error writing zerocoinDB to disk"),
QT_TRANSLATE_NOOP("jdcoin-core", "Error"),
QT_TRANSLATE_NOOP("jdcoin-core", "Error: -listen must be true if -masternode is set."),
QT_TRANSLATE_NOOP("jdcoin-core", "Error: -maxmempool must be at least %d MB"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Error: Invalid port %d for running a masternode."),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Failed to accept tx in the memory pool (reason: %s)\n"),
QT_TRANSLATE_NOOP("jdcoin-core", "Failed to find Zerocoins in wallet database"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Fee (in %s/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Insufficient funds."),
QT_TRANSLATE_NOOP("jdcoin-core", "Invalid -masternodeaddr address: %s"),
QT_TRANSLATE_NOOP("jdcoin-core", "Invalid -masternodeaddr port %d, only %d is supported on %s-net."),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Invalid port %d detected in masternode.conf"),
QT_TRANSLATE_NOOP("jdcoin-core", "Invalid status error."),
QT_TRANSLATE_NOOP("jdcoin-core", "Keep at most <n> unconnectable transactions in memory (default: %u)"),
QT_TRANSLATE_NOOP("jdcoin-core", "Keep the transaction memory pool below <n> megabytes (default: %u)"),
QT_TRANSLATE_NOOP("jdcoin-core", "Keypool ran out, please call keypoolrefill first, or unlock the wallet."),
QT_TRANSLATE_NOOP("jdcoin-core", "Limit size of signature cache to <n> MiB (default: %u)"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Masternodes are required to run on port %d for %s-net"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Mining/Staking options:"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Reindex the %s and z%s money supply statistics"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Shutdown requested over the txs scan. Exiting."),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Specify zk params directory (default: %s)"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "The threshold value cannot be less than %s"),
...
QT_TRANSLATE_NOOP("jdcoin-core", "This is not a masternode. 'local' option disabled."),
QT_TRANSLATE_NOOP("jdcoin-core", "This is not a masternode."),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Transaction canceled."),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Upgrading coins database..."),
...
QT_TRANSLATE_NOOP("jdcoin-core", "Wallet debugging/testing options:"),
