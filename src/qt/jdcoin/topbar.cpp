    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopJdc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountJdc}, "amount-topbar");
    setCssProperty({ui->labelPendingJdc, ui->labelImmatureJdc}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // jdc Total
    QString totalJdc = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    ui->labelPendingJdc->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
    ui->labelImmatureJdc->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
