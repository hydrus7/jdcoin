    ...
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableJDC,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableJDC,
    ...
    connect(ui->pushButton_UnspendableJDC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableJDC);});
