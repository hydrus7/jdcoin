...
extern UniValue setzjdcoineed(const JSONRPCRequest& request);
extern UniValue getzjdcoineed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzjdc(const JSONRPCRequest& request);
extern UniValue dzjdcointate(const JSONRPCRequest& request);
