...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"jdcoin", "listmasternodes", &listmasternodes, true },
        {"jdcoin", "getmasternodecount", &getmasternodecount, true },
        {"jdcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"jdcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"jdcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"jdcoin", "masternodecurrent", &masternodecurrent, true },
        {"jdcoin", "startmasternode", &startmasternode, true },
        {"jdcoin", "createmasternodekey", &createmasternodekey, true },
        {"jdcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"jdcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"jdcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"jdcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"jdcoin", "getmasternodescores", &getmasternodescores, true },
        {"jdcoin", "preparebudget", &preparebudget, true },
        {"jdcoin", "submitbudget", &submitbudget, true },
        {"jdcoin", "mnbudgetvote", &mnbudgetvote, true },
        {"jdcoin", "getbudgetvotes", &getbudgetvotes, true },
        {"jdcoin", "getnextsuperblock", &getnextsuperblock, true },
        {"jdcoin", "getbudgetprojection", &getbudgetprojection, true },
        {"jdcoin", "getbudgetinfo", &getbudgetinfo, true },
        {"jdcoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"jdcoin", "mnfinalbudget", &mnfinalbudget, true },
        {"jdcoin", "checkbudgets", &checkbudgets, true },
        {"jdcoin", "mnsync", &mnsync, true },
        {"jdcoin", "spork", &spork, true },
