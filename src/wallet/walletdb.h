...
public:
    ...
    bool WriteZJDCOINeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZJDCOINeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZJDCOINeed_deprecated(uint256& seed);
    bool EraseZJDCOINeed();
    bool EraseZJDCOINeed_deprecated();
